...
project [does not accept](.github/config.yml) other issue types:
    - [bug reports](.github/bug.yml)
    - [maintenance suggestions or issues](.github/chore.yml)
    - [documentation suggestions or issues](.github/documentation.yml)
    - [feature requests](.github/feature.yml)
    - [localization suggestions or issues](.github/localisation.yml)
    - [questions related to project usage](.github/question.yml)
    - [refactoring suggestions](.github/refactoring.yml)
