...
project so that we can improve it together while also creating a welcoming space 
for everyone to participate. Following these guidelines will help ensure a 
positive experience for contributors and maintainers.**

## 📖 Code of Conduct

Please review our [Code of Conduct](CODE_OF_CONDUCT.md). It is in effect at all 
times. We expect it to be honored by everyone who contributes to this project. 
Acting like an asshole will not be tolerated.

## 💡 Asking Questions

See our [Support Guide](SUPPORT.md). In short, GitHub issues are not the 
...
- **Review the documentation and [Support Guide](SUPPORT.md)** before opening a 
new issue.
...
Your idea may be great, but also out-of-scope for the project. If accepted, we 
cannot make any commitments regarding the timeline for implementation and 
...
a single large one. Enormous pull requests will take enormous amounts of time to 
review, or may be rejected altogether. 
...
Add a more detailed explanation here, if necessary. Possibly give some 
background about the issue being fixed, etc. The body of the commit message can 
be several paragraphs. Further paragraphs come after blank lines and please do 
proper word-wrap.

Wrap it to about 72 characters or so. In some contexts, the first line is 
treated as the subject of the commit and the rest of the text as the body. The 
blank line separating the summary from the body is critical (unless you omit the 
body entirely); various tools like `log`, `shortlog` and `rebase` can get 
confused if you run the two together.

Explain the problem that this commit is solving. Focus on why you are making 
this change as opposed to how or what. The code explains how or what. Reviewers 
and your future self can read the patch, but might not understand why a 
particular solution was implemented. Are there side effects or other unintuitive 
...
constructively criticized, remember that you are not your code. Do not take code 
review personally.
...
GitHub Copilot, ChatGPT, Claude, Cursor, etc.), provided that the following 
principles are respected:

### 🧭 Accountability

You **MUST** take full responsibility for your contributions. Even if parts were 
assisted or generated by an AI tool, you remain the author and are accountable 
for the accuracy, license compliance, and overall quality of the submission. AI 
tools are helpers, not substitutes for understanding or judgment.

**For the purposes of the Developer Certificate of Origin (DCO), by submitting, 
you affirm that you treat the AI-generated content reviewed by you as your own 
intellectual property or as a modification over which you possess the necessary 
rights of disposition.**

### 🔍 Transparency

You **MUST** disclose the use of AI tools when a **significant part** of your 
contribution is taken from a tool **without changes**. You **SHOULD** disclose 
other uses of AI tools where it might be useful. Routine use of assistive tools 
for grammar, spelling, or clarifying language **does not require disclosure.**

**Recommended format:**
Add a line to your commit message or pull request description such as:
```
Assisted-by: ChatGPT (optional link to exported chat)
Assisted-by: GitHub Copilot (optional link to exported chat)
```

### ✅ Quality & Review

AI-assisted content will be reviewed according to the same or stricter standards 
as any human-written code or text. You are expected to verify, test, and 
understand every part of what you submit.

### ⚖️ Ethical Use

AI tools **MUST NOT** be used as the final arbiter of human decisions or 
community judgments. Automated testing, linting, and CI/CD validation are 
welcome, but human review is always required before acceptance.

By submitting AI-assisted work, you confirm that you have reviewed and verified 
it and that it complies with these guidelines.
...
section that combines the precision of the 
